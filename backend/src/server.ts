...
import { initDB } from "./services/mongodb.js"
import { signup, loginUser } from "./Controllers/userController.js";
import { createContact, getContacts, deleteContact, updateContact } from "./Controllers/contactsController.js";
...
app.put('/api/contacts/edit/:id', auth, updateContact);
